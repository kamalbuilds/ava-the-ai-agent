...
export function CrossChainBridge({ onAction, isLoading = false }: CrossChainBridgeProps) {
  ...
  const handleActivate = () => {
    ...
    toast({
      ...
      description: `🌉 Cross-Chain Bridge Integration for NEAR has been ${isActive ? 'deactivated' : 'activated'} successfully`,
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-white flex items-center gap-2">
            ...
            🌉 Cross-Chain Bridge Integration for NEAR
          </h1>
      ...
      <Card className="bg-gray-800 border-gray-700">
        <CardHeader>
          <CardTitle className="text-white">CrossChainBridge Status</CardTitle>
