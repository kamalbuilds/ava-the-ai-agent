...
export function VoiceEnabledChat({ onAction, isLoading = false }: VoiceEnabledChatProps) {
  ...
  const handleActivate = () => {
    ...
    toast({
      ...
      description: `🤖 NEAR AI Chat Interface with Voice Recognition has been ${isActive ? 'deactivated' : 'activated'} successfully`,
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-white flex items-center gap-2">
            ...
            🤖 NEAR AI Chat Interface with Voice Recognition
          </h1>
      ...
      <Card className="bg-gray-800 border-gray-700">
        <CardHeader>
          <CardTitle className="text-white">VoiceEnabledChat Status</CardTitle>
