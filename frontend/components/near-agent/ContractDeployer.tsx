...
export function ContractDeployer({ onAction, isLoading = false }: ContractDeployerProps) {
  ...
  const handleActivate = () => {
    ...
    toast({
      ...
      description: `🎯 NEAR Smart Contract Deployment Tool has been ${isActive ? 'deactivated' : 'activated'} successfully`,
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-white flex items-center gap-2">
            ...
            🎯 NEAR Smart Contract Deployment Tool
          </h1>
      ...
      <Card className="bg-gray-800 border-gray-700">
        <CardHeader>
          <CardTitle className="text-white">ContractDeployer Status</CardTitle>
