...
let HelloNear = (_dec = NearBindgen({}), _dec2 = initialize(), _dec3 = view(), _dec4 = call({}), _dec5 = view(), _dec6 = call({}), _dec7 = view(), _dec8 = view(), _dec9 = view(), _dec10 = call({}), _dec11 = call({}), _dec12 = call({}), _dec13 = call({}), _dec(_class = (_class2 = class HelloNear {
  greeting = 'Hello';
  greeting_history = [];
  user_greetings = {};
  interaction_count = 0;
  last_interaction_timestamp = BigInt(0);
  contributors = [];
  init() {
  ...
  set_greeting({
    ...
    this.last_interaction_timestamp = blockTimestamp();
  ...
  set_user_greeting({
    ...
    const user_id = predecessorAccountId();
    log(`Setting greeting for user ${user_id}: ${greeting}`);
  ...
  increment_interactions() {
    ...
    log(`Interaction count incremented to ${this.interaction_count}`);
  }
  clear_greeting_history() {
    const sender = predecessorAccountId();
    ...
    this.interaction_count += 1;
    this.last_interaction_timestamp = blockTimestamp();
    log(`Greeting history cleared by ${sender}`);
    return true;
  }
  ping_contract({
    message
    ...
    const sender = predecessorAccountId();
    log(`Received ping from ${sender}: ${message}`);
    this.interaction_count += 1;
    this.last_interaction_timestamp = blockTimestamp();
  ...
  call_another_contract({
    ...
    this.interaction_count += 1;
    this.last_interaction_timestamp = blockTimestamp();
    return NearPromise.new(contract_id).functionCall(method, args, NO_DEPOSIT, GAS);
  }
}, _applyDecoratedDescriptor(_class2.prototype, "init", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "init"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_greeting", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "get_greeting"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "set_greeting", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "set_greeting"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_greeting_history", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "get_greeting_history"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "set_user_greeting", [_dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "set_user_greeting"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_user_greeting", [_dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "get_user_greeting"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_user_greeting_for_caller", [_dec8], Object.getOwnPropertyDescriptor(_class2.prototype, "get_user_greeting_for_caller"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_stats", [_dec9], Object.getOwnPropertyDescriptor(_class2.prototype, "get_stats"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "increment_interactions", [_dec10], Object.getOwnPropertyDescriptor(_class2.prototype, "increment_interactions"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "clear_greeting_history", [_dec11], Object.getOwnPropertyDescriptor(_class2.prototype, "clear_greeting_history"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "ping_contract", [_dec12], Object.getOwnPropertyDescriptor(_class2.prototype, "ping_contract"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "call_another_contract", [_dec13], Object.getOwnPropertyDescriptor(_class2.prototype, "call_another_contract"), _class2.prototype), _class2)) || _class);
function call_another_contract() {
  ...
  const _result = _contract.call_another_contract(_args);
...
function ping_contract() {
  ...
  const _args = HelloNear._getArgs();
  const _result = _contract.ping_contract(_args);
  HelloNear._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(HelloNear._serialize(_result, true));
}
function clear_greeting_history() {
  const _state = HelloNear._getState();
  if (!_state && HelloNear._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = HelloNear._getArgs();
  const _result = _contract.clear_greeting_history(_args);
  HelloNear._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(HelloNear._serialize(_result, true));
}
function increment_interactions() {
  const _state = HelloNear._getState();
  if (!_state && HelloNear._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = HelloNear._getArgs();
  const _result = _contract.increment_interactions(_args);
  HelloNear._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(HelloNear._serialize(_result, true));
}
function get_stats() {
  ...
  const _args = HelloNear._getArgs();
  const _result = _contract.get_stats(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(HelloNear._serialize(_result, true));
}
function get_user_greeting_for_caller() {
  const _state = HelloNear._getState();
  if (!_state && HelloNear._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = HelloNear._getArgs();
  const _result = _contract.get_user_greeting_for_caller(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(HelloNear._serialize(_result, true));
}
function get_user_greeting() {
  ...
  const _args = HelloNear._getArgs();
  const _result = _contract.get_user_greeting(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(HelloNear._serialize(_result, true));
}
function set_user_greeting() {
  const _state = HelloNear._getState();
  if (!_state && HelloNear._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = HelloNear._getArgs();
  const _result = _contract.set_user_greeting(_args);
  HelloNear._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(HelloNear._serialize(_result, true));
}
function get_greeting_history() {
  const _state = HelloNear._getState();
  if (!_state && HelloNear._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = HelloNear._getArgs();
  const _result = _contract.get_greeting_history(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(HelloNear._serialize(_result, true));
}
...
export { call_another_contract, clear_greeting_history, get_greeting, get_greeting_history, get_stats, get_user_greeting, get_user_greeting_for_caller, increment_interactions, init, ping_contract, set_greeting, set_user_greeting };
