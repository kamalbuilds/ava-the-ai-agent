...
let HelloNear = (_dec = NearBindgen({}), _dec2 = initialize(), _dec3 = view(), _dec4 = call({}), _dec5 = view(), _dec6 = call({}), _dec7 = view(), _dec8 = view(), _dec9 = view(), _dec10 = call({}), _dec11 = call({}), _dec12 = call({}), _dec(_class = (_class2 = class HelloNear {
  greeting = 'Hello';
  greeting_history = [];
  user_greetings = {};
  interaction_count = 0;
...
export { clear_greeting_history, get_greeting, get_greeting_history, get_stats, get_user_greeting, get_user_greeting_for_caller, increment_interactions, init, ping_contract, set_greeting, set_user_greeting };
