...
export function DeFiAnalyticsDashboard({ onAction, className = "" }: DeFiAnalyticsDashboardProps) {
  ...
  const handleToggle = async () => {
    ...
    try {
      ...
      onAction?.(isActive ? 'deactivate' : 'activate', { component: 'DeFiAnalyticsDashboard' });
      
      toast({
        title: isActive ? "Deactivated" : "Activated",
        description: `📊 Real-time DeFi Analytics Dashboard has been ${isActive ? 'deactivated' : 'activated'} successfully`,
          ...
          {isActive && (
            <Alert className="bg-blue-900/20 border-blue-700">
              ...
              <AlertDescription className="text-blue-300">
                🚀 DeFiAnalyticsDashboard is actively optimizing your portfolio with AI-powered strategies
              </AlertDescription>
            </Alert>
          )}
        </TabsContent>
