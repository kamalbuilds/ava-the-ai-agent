...
interface CrossChainBridgeManagerProps {
...
export function CrossChainBridgeManager({ onAction, className = "" }: CrossChainBridgeManagerProps) {
  ...
  const handleToggle = async () => {
    ...
    try {
      ...
      onAction?.(isActive ? 'deactivate' : 'activate', { component: 'CrossChainBridgeManager' });
      
      toast({
        title: isActive ? "Deactivated" : "Activated",
        description: `🌐 Cross-Chain Bridge Manager has been ${isActive ? 'deactivated' : 'activated'} successfully`,
          ...
          {isActive && (
            <Alert className="bg-blue-900/20 border-blue-700">
              ...
              <AlertDescription className="text-blue-300">
                🚀 CrossChainBridgeManager is actively optimizing your portfolio with AI-powered strategies
              </AlertDescription>
            </Alert>
          )}
        </TabsContent>
