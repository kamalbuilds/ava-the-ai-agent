import { amount, Chain, ChainContext, Network, Signer, Wormhole } from "@wormhole-foundation/sdk";
 ...
 */
export async function getSigner<N extends Network, C extends Chain>(chain: ChainContext<N, C>): Promise<any> {
